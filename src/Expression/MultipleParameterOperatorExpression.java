...
public class MultipleParameterOperatorExpression extends Expression {
	 ...
	 * sub-expressions.
	 */
	public MultipleParameterOperatorExpression(String Command, ArrayList<Expression> OperandList) {
		myCommand = Command;
	...
	public RGBColor evaluate(double DomainX, double DomainY , double CurrentTime) {
			...
			return ColorCombinations.doMultipleParameterOperator(myCommand, parameterList);
	}
